---
name: setup
description: '[dalen] Open the local settings UI to configure theme, auto-open, timeouts, renderer toggles, and size limits. Trigger: "dalen settings", "open dalen settings", "change the report theme", "dalen 설정"'
user_invocable: true
argument-hint: ""
---
...
Open the dalen settings UI in a local browser.
...
- Ask the user for theme, timeout, port, or any other value — the web UI
  collects all of it.
- Call any other dalen tool from this skill.
