...
export const DALEN_HOME = join(claudeRoot(), "plugins", "dalen");
export const CONFIG_PATH = join(DALEN_HOME, "config.json");
export const RUNTIME_DIR = join(DALEN_HOME, "runtime");
