...
const SETTINGS_HTML = `<!doctype html><html data-theme="auto"><head><title>s</title></head><body><script>window.__DALEN_STATE__="__DALEN_STATE__";</script></body></html>`;

let baseUrl = "";
let token = "";

beforeAll(() => {
  const pluginRoot = mkdtempSync(join(tmpdir(), "dalen-settings-"));
