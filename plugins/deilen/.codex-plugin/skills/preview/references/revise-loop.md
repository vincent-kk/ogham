...
3. **Re-parse, then re-render.** If any edit touched a mermaid fence, run the preview skill's Mermaid parse gate again (Step 3), then call `mcp__deilen__render_viewer` on the updated document and collect again (Step 5 of the skill).
