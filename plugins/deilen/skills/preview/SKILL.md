...
- Poll in a loop, or pass a short `wait_seconds` to force one — a single `mcp__plugin_deilen_tools__collect_feedback` is bounded and already waits out the whole review.
