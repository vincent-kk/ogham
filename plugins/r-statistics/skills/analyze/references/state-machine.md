...
| STATISTICIAN_PLAN | SAP produced | ASSERT_PLAN | statistician call *(interactive: present SAP)* |
...
| VALIDATION | ok / soft_warning | REPORTING (or return) | *(interactive: discuss → improve)* |
