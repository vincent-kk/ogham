# changeTracker -- PostToolUse 변경 추적 (disabled)
...
- `changeTracker.ts` — `trackChange`, `classifyPathCategory` / `appendChangeLog` (internal)
...
- `../../core/infra/changeQueue/` (`ChangeQueue`, `ChangeRecord`)
- `../../core/tree/organClassifier/` (`classifyNode`, `KNOWN_ORGAN_DIR_NAMES`)
- `../../types/hooks.js`, `../utils/validateCwd.js`
- `node:fs`, `node:path`
