...
/**
 * Appends stable missing-file diagnostics to snapshot diagnostics.
 *
 * @param snapshotDiagnostics - Diagnostics already produced by the snapshot.
 * @param missingPaths - Requested verification paths absent from the snapshot.
 * @returns A fresh combined diagnostic list.
 */
