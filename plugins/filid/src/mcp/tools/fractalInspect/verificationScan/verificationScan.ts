...
/** Input accepted by the `fractal_inspect` verification action. */
...
/**
 * Summarizes verification-document evidence from one project snapshot.
 *
 * @param input - Project root, optional file filter, and detail projection.
 * @returns The role-aware summary and optional per-file evidence.
 */
