...
`fractal_inspect`의 `verification` action에서 snapshot의 adapter evidence로 spec-document/test-record case cap, fragmentation, DETAIL contract link와 certainty를 요약한다.
