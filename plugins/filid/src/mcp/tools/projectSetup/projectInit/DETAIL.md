# project_setup init action contract
...
- Keep rule-document synchronization outside this action.
...
- 2026-09-05 — Moved the unchanged initialization payload behind `project_setup` action `init`.
