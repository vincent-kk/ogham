...
rounds: 1
plan_required: false
risk_reasons: ["public-boundary: src/beta/index.ts"]
depends_on: []
source_hash: 75d87434d91a74ebf40dd1439340f966b44f9f47f742f23bf76b63c348bf1610
base_ref: "main"
output: opinions/review-02.r1.json
---
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| src/beta/index.ts | M | source | src/beta |  | 2 | diffs/02/01-index.ts.diff | 1-1 |
...
```diff
diff --git a/src/beta/index.ts b/src/beta/index.ts
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| FCA-002 | structure | documents | contract | error | src/beta | intent-document-contract | INTENT.md is required for fractal node <PROJECT_ROOT>/src/beta. |
...
- findings: [{id:R02-NNN,severity:error|warning,category:bug|security|performance|maintainability|test|documentation|contract|structure|verification,path,existingCode,lines,rule,message,evidence,consequence,recommendedAction}]; nonblank text; assigned path; lines=range|unknown.
