...
import { computeProjectHash } from '../../../core/infra/projectHash/projectHash.js';
import { handleCacheManage } from '../../../mcp/tools/cacheManage/cacheManage.js';
import type {
  ComputeHashResult,
  GetHashResult,
  SaveHashResult,
} from '../../../mcp/tools/cacheManage/cacheManage.js';

vi.mock('../../../core/infra/cacheManager/cacheManager.js', () => ({
  saveRunHash: vi.fn(),
  getLastRunHash: vi.fn(() => null),
}));

vi.mock('../../../core/infra/projectHash/projectHash.js', () => ({
