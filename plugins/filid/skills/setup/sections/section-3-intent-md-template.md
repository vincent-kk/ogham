...
From the `fractal_scan(detail: "paths")` result and document findings from `structure_validate`, list fractal nodes that lack INTENT.md. Setup proposes these files; it does not author or overwrite them.
