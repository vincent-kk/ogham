...
> - After parallel `context-manager` returns — chain Stage 7 validation (`mcp__plugin_filid_tools__doc_compress`, `mcp__plugin_filid_tools__structure_validate`) in the same turn
