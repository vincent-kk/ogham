...
| `mcp__plugin_filid_tools__coverage_verify`  | 3     | Test coverage verification                       |
| `mcp__plugin_filid_tools__test_metrics`     | 3     | 3+12 rule validation and decision recommendation |
| `mcp__plugin_filid_tools__ast_analyze`      | 4, 5  | LCOM4, CC metrics, dependency DAG                |
