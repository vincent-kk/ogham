...
- `index.ts` — 순수 barrel (공개 API: calculateWeights/computePageRank/normalizeWeights/getLayerDecay + HUB_DECAY_FACTOR/LAYER_DECAY_FACTORS/SUBLAYER_DECAY_FACTORS 재노출 + 타입)
