...
- `index.ts` — 순수 barrel (공개 API: getActivityEventsDir/getActivityEventPath/appendActivityEvent/readActivityEvents/buildToolDescription)
- `operations/` organ — 경로 헬퍼·append·라인 단위 read, 도구명+입력 → 활동 설명, 함수 1개/파일
