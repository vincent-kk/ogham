...
볼트 디렉토리 스캔. 파일 목록, 스냅샷 생성, 변경 세트 계산. 인덱싱 대상은 레이어 디렉토리 allowlist(`VAULT_SCAN_LAYER_PATTERNS`)로 한정한다 — vault 의 서고 디렉토리(99_Archive)와 vault 루트 문서는 frontmatter가 유효해도 스캔 대상이 아니다.
