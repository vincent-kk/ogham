/**
 * @file configProvisioner.test.ts
...
import { provisionMissingConfigs } from '../../hooks/utils/configProvisioner/configProvisioner.js';
import { CONFIG_REGISTRY } from '../../hooks/utils/configRegistry/configRegistry.js';
