...
- **Migration assumes exclusive vault access.** Do not run other maencof tools (`mcp__maencof__kg_build`, `mcp__maencof__create`, `mcp__maencof__update`, etc.) concurrently during migration.
