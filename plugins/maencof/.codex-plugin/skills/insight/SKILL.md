...
2. Use `mcp__maencof__kg_search` with `seed: ["auto-insight"]` and `max_results: 10`, then `mcp__maencof__read` to confirm creation dates when needed.
...
| Tool                                   | Purpose                                                         |
| -------------------------------------- | --------------------------------------------------------------- |
| `mcp__maencof__kg_search` | Find related knowledge or a bounded auto-insight sample |
| `mcp__maencof__read` | Verify complete claims and capture dates |
| `mcp__maencof__capture_insight` | Record novel automatic insights with capture-time gates |
