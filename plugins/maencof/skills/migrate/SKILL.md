...
- **Migration assumes exclusive vault access.** Do not run other maencof tools (`mcp__plugin_maencof_t__kg_build`, `mcp__plugin_maencof_t__create`, `mcp__plugin_maencof_t__update`, etc.) concurrently during migration.
