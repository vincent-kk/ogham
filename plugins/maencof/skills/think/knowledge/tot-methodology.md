...
**Evaluation Framework**: 5 axes (total 100 points). See `knowledge/evaluation-criteria.md` for the per-criterion scoring bands (single source of truth for all modes).
...
- **Tie-breaking priority**: reusability > single responsibility > efficiency
