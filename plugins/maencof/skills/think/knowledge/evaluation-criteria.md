...
> **Core Principle**: Evaluation based on objective criteria, minimizing subjective judgment **Quality Assurance**: All scores must be measurable and verifiable **Mode discipline**: Never mix axis definitions across modes — each mode defines its own 100-point distribution
