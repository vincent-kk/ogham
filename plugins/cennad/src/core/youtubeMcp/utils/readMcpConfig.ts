...
// agy's mcp_config.json shape (only `mcpServers` is meaningful to cennad). Other
// top-level keys are preserved verbatim on write so cennad never clobbers fields
