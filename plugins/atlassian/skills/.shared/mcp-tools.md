...
The table uses the Claude/agy full form. On Codex, use `mcp__atlassian__<tool>` instead (for example, `mcp__atlassian__jira_comment_thread`).
...
| `mcp__plugin_atlassian_tools__jira_comment_thread` | —                         | Jira Server/DC comment thread with reply-plugin replies merged from the changelog (read/scan/probe/save_profile) |

## Tool Usage by Skill

| Skill        | Tools Used                                                                                                    |
| ------------ | ------------------------------------------------------------------------------------------------------------- |
| `jira`       | `mcp__plugin_atlassian_tools__fetch`, `mcp__plugin_atlassian_tools__jira_comment_thread` (DC comment listing) |
