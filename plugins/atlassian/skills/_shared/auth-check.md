...
Authentication check using the `mcp__plugin_atlassian_tools__auth_check` MCP tool.
...
1. Call `mcp__plugin_atlassian_tools__auth_check` with `connection_test: true`
