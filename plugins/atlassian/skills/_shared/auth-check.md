...
Authentication check using the `mcp_tools_auth_check` MCP tool.

## Tool

| Tool | Parameter | Default | Description |
|---|---|---|---|
| `mcp_tools_auth_check` | `connection_test` | `false` | When `true`, tests live connectivity and returns user info |
