// Atlassian Settings UI - JSON Import Modal
"use strict";
...
(function () {
  ...
  function doImport(text) {
    ...
    if (isSeparate) {
      app.activateTab(app.TABS.ON_PREMISE);
      fillOnPremFields(env, app);
    } else {
      app.activateTab(app.TABS.CLOUD);
  ...
  function fillCloudFields(env, app) {
    ...
    app.setField(
      "cloud.username",
      env["JIRA_USERNAME"] || env["CONFLUENCE_USERNAME"] || "",
    );
    app.setField(
      "cloud.api_token",
