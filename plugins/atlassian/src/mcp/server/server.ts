...
import {
  handleCommentThread,
  type CommentThreadArgs,
} from "../tools/commentThread/index.js";
...
export function createServer(): McpServer {
  ...
  server.registerTool(
    McpToolName.COMMENT_THREAD,
    {
      ...
      inputSchema: CommentThreadInputSchema,
      annotations: {
        readOnlyHint: false,
