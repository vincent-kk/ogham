...
MCP 서버 인스턴스 생성 및 5개 도구(fetch, convert, auth_check, setup, jira_comment_thread) 등록·라우팅. stdio 트랜스포트로 Claude Code와 통신한다.
...
- `../tools/{fetch,convert,setup,authCheck,jiraCommentThread}` — 도구 핸들러
