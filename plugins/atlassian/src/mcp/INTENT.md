...
MCP server and 4 generic HTTP/utility tools. Zero domain knowledge — executes (method, path, params, body) tuples.
...
| `tools/` | 4 tool handlers (fetch, convert, auth_check, setup) |
