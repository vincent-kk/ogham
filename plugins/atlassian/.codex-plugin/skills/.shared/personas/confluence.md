...
tools:
  ...
  - mcp__atlassian__convert
  - mcp__atlassian__auth_check
  - mcp__atlassian__setup
maxTurns: 30
---
...
4. To show page text, read the storage body and convert it with `mcp__atlassian__convert` (`storage` → `markdown`).
