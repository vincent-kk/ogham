...
| mcp__imbas__manifest_save schema rejection   | Repair the payload against references/output-schema.md and re-save; if unrepairable, report the Zod error and stop. |
