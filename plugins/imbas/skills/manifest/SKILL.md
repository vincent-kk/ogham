...
>
> - Provider [OP:] loops — after EACH item creation, save manifest via `mcp__plugin_imbas_tools__manifest_save` and chain the next item in the same turn (do NOT pause to report partial progress)
