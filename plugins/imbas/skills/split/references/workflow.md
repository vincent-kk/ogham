...
Step 2 — Epic Decision Flow
  - If --epic provided:
    ...
    2. If found: store epic_ref in state.json via mcp__plugin_imbas_tools__run_transition context.
...
Step 7 — User Review Flow
  ...
  Option A — Approve:
    ...
    2. Emit terminal marker with next-step guidance:
       "Split complete: <N> Stories. Next: /imbas:manifest stories to create Jira issues,
