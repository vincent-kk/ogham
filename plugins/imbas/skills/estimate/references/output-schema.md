...
```jsonc
{
  ...
  "config_used": { "team_size": 2, "buffer_ratio": 0.2, "...": "coefficients actually applied (CLI overrides included)" },
  "units": [
    {
      "id": "U-1",                       // stable within this manifest
      "name": "이메일 로그인",
      "view_refs": {                     // which views surfaced this unit
        "page": ["로그인 화면"],
        "feature": ["이메일 로그인"],
        "module": ["인증"]
      },
      ...
      "estimate": {
        "o": 1.5, "m": 3, "p": 6,        // three-point, man-days
