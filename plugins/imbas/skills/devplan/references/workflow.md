...
Step 1 — Load Run & Manifest Checks
  1. Call mcp__plugin_imbas_tools__run_get(project_ref, run_id) to load state.json.
  ...
  3. Call mcp__plugin_imbas_tools__manifest_get(project_ref, run_id, type: "stories")
  ...
  5. Call mcp__plugin_imbas_tools__run_transition:
...
Step 2 — engineer Agent Spawn
  ...
  - Agent execution steps:
    Step 2a — Per-Story Code Exploration
      ...
      - Tools: mcp__plugin_imbas_tools__ast_search for pattern matching, mcp__plugin_imbas_tools__ast_analyze for
...
Step 4 — User Review Flow
  ...
  Option A — Approve:
    1. Call mcp__plugin_imbas_tools__manifest_validate(project_ref, run_id, type: "devplan")
