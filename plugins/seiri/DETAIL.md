...
- 목록 밖 스킬(execute·mental-model·trace-change·request-review·scaffold-pr·기타)의 본문에는 정본 문장이 없다 — 원장·HTML·PR·인계물의 언어는 각각 원장 포맷·독자·저장소 관례가 정한다.
...
2026-08-30 — write-plan 과 review-plan 을 선택된 planning method 우선 계약으로 갱신했다.
