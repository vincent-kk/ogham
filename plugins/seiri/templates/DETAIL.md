...
- `gates/` 는 값 없는 스캐폴드다. 임계·검증 명령은 저장소가 소유하며 여기에 박제하지 않는다.
...
- `gates/` — 저장소 게이트 placeholder 골격. 사용자가 값을 채운다.
...
### AC-gates-valueless — 게이트 스캐폴드

- `gates/` 파일에 구체적 임계값이나 검증 명령이 들어 있지 않다.

## Last Updated

2026-07-30 — 규칙 템플릿의 해시 안정성 계약을 문서화했다.
