...
### [`@ogham/cogair`](./plugins/cogair/) — Codex / Gemini CLI 위임
...
자세한 문서는 [cogair README (영문)](./plugins/cogair/README.md) 또는 [cogair README (한글)](./plugins/cogair/README-ko_kr.md)을 참조하세요.
...
- **토큰 예산 컨텍스트 조립** — `/maencof-lens:context`가 목표 토큰 예산 안에서 관련 볼트 문서를 조립하여 프롬프트에 주입
...
| **[`cogair`](./plugins/cogair/)**             | Claude plugin | Claude Code에서 OpenAI Codex CLI / Google Gemini CLI로 위임 |
