...
- [Preconditions](./preconditions.md) — state.json requirements before running
- [Workflow](./workflow.md) — Steps 1–7 (Epic decision, agent spawn, verification, manifest, review)
- [Escape Conditions](./escape-conditions.md) — E2-1, E2-2, E2-3, EC-1, EC-2 escape logic
- [Tools Used](./tools.md) — imbas MCP tools, Atlassian MCP tools, agent spawn instructions
- [Error Handling](./errors.md) — error table
- [State Transitions & Output](./state-transitions.md) — entry/exit states and output artifact
