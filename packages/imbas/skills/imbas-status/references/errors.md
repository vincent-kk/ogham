...
| Error | Action |
|-------|--------|
| No config.json found | Display: "imbas not initialized. Run /imbas:imbas-setup first." |
| No project key configured | Display: "No default project. Run /imbas:imbas-setup set-project <KEY>." |
