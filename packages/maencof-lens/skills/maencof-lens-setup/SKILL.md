...
# maencof-lens-setup — Lens Configuration Manager
...
```
/maencof-lens:maencof-lens-setup init
/maencof-lens:maencof-lens-setup show
/maencof-lens:maencof-lens-setup add work /Users/me/work-vault
/maencof-lens:maencof-lens-setup set-default work
/maencof-lens:maencof-lens-setup set-layers work 3,4
/maencof-lens:maencof-lens-setup remove work
```
