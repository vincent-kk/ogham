...
# maencof-explore — Interactive Knowledge Exploration
...
```
/maencof:maencof-explore react
/maencof:maencof-explore 01_Core/identity.md --hops 3
/maencof:maencof-explore machine-learning --layer 3
/maencof:maencof-explore alice --sub-layer relational
/maencof:maencof-explore project goals --detail
```
...
```
# Explore by keyword
/maencof:maencof-explore machine-learning

# Explore from a specific document
/maencof:maencof-explore 01_Core/identity.md

# Layer filter + deep exploration
/maencof:maencof-explore AI --layer 2 --hops 8

# Include detailed body content
/maencof:maencof-explore values --detail
```
