...
# maencof-rule — Behavioral Rule Management
...
> For CLAUDE.md changes, use `/maencof:maencof-instruct` instead.
...
| Execution | `{CWD}/CLAUDE.md` | No — use `/maencof:maencof-instruct` |
...
```
/maencof:maencof-rule [mode] [name]
```
