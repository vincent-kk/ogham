...
```
/maencof:maencof-rule add
/maencof:maencof-rule list
/maencof:maencof-rule edit api-security
/maencof:maencof-rule remove test-rules
/maencof:maencof-rule show general
```
