...
```
이 질문은 건너뛰겠습니다. 나중에 /maencof:maencof-setup --step 2 로 다시 설정할 수 있습니다.
```
...
다음 명령어로 시작해보세요:
- /maencof:maencof-remember — 새로운 지식 기록
- /maencof:maencof-recall — 기억 검색
- /maencof:maencof-build — 전체 인덱스 빌드
- /maencof:maencof-checkup — 시스템 상태 확인
```
