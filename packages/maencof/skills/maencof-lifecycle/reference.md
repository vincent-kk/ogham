...
Instant test: /maencof:maencof-lifecycle --test greeting
```
...
```
/maencof:maencof-lifecycle add
/maencof:maencof-lifecycle list
/maencof:maencof-lifecycle disable commit-reminder
/maencof:maencof-lifecycle --test greeting
/maencof:maencof-lifecycle remove session-summary
```
...
|-----------|------------|
| `lifecycle.json` missing | Check `.maencof-meta/`; auto-create if vault initialized; suggest `/maencof:maencof-setup` otherwise |
