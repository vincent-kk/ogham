...
```
/maencof:maencof-instruct
/maencof:maencof-instruct --scan
/maencof:maencof-instruct --split
/maencof:maencof-instruct --local
/maencof:maencof-instruct --restore
```
