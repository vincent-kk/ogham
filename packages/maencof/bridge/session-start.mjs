...
- The system tracks document freshness automatically via the knowledge graph`}import{copyFileSync as be,existsSync as $,readFileSync as J,writeFileSync as G}from"node:fs";var D="<!-- MAENCOF:START -->",v="<!-- MAENCOF:END -->";function L(e,t,n={}){let{dryRun:i=!1,createIfMissing:o=!0}=n,s=[D,t.trim(),v].join(`
`);if(!$(e)){if(!o)return{changed:!1,hadExistingSection:!1,content:s};let S=s+`
`;return i||G(e,S,"utf-8"),{changed:!0,hadExistingSection:!1,content:S}}let a=J(e,"utf-8"),d=a.indexOf(D),h=a.indexOf(v),r,c;if(d!==-1&&h!==-1&&d<h){c=!0;let S=a.slice(0,d),R=a.slice(h+v.length);r=S+s+R}else{c=!1;let S=a.endsWith(`
`)?`
`:`

`;r=a+S+s+`
`}if(r===a)return{changed:!1,hadExistingSection:c,content:a};let y;return i||(y=e+".bak",be(e,y),G(e,r,"utf-8")),{changed:!0,hadExistingSection:c,backupPath:y,content:r}}function Y(e){if(!$(e))return null;let t=J(e,"utf-8"),n=t.indexOf(D),i=t.indexOf(v);if(n===-1||i===-1||n>=i)return null;let o=n+D.length;return t.slice(o,i).trim()}import{appendFileSync as Le,existsSync as we,mkdirSync as Ne,writeFileSync as Te}from"node:fs";import{dirname as Me,join as B}from"node:path";var H=".maencof",m=".maencof-meta",W="dailynotes";function Fe(e){return B(e,".maencof-meta",W)}function je(e,t){let n=t??X(new Date);return B(Fe(e),`${n}.md`)}function Pe(e){let t=e.path?` \u2192 ${e.path}`:"";return`- **[${e.time}]** \`${e.category}\` ${e.description}${t}`}function K(e,t){let n=je(e),i=Me(n);Ne(i,{recursive:!0});let o=Pe(t);if(we(n))Le(n,o+`
`,"utf-8");else{let a=`# Dailynote \u2014 ${X(new Date)}

## Activity Log

`;Te(n,a+o+`
`,"utf-8")}}function z(e){let t=String(e.getHours()).padStart(2,"0"),n=String(e.getMinutes()).padStart(2,"0");return`${t}:${n}`}function X(e){let t=e.getFullYear(),n=String(e.getMonth()+1).padStart(2,"0"),i=String(e.getDate()).padStart(2,"0");return`${t}-${n}-${i}`}import{existsSync as Ge,mkdirSync as Vt,readFileSync as $e,writeFileSync as Ut}from"node:fs";import{dirname as $t,join as Je}from"node:path";var f={schema_version:1,injection:{enabled:!0,budget_chars:2e3},session_recap:{enabled:!0}},q="MAENCOF_DISABLE_DIALOGUE",Q="dialogue-config.json";function w(e){return e!==null&&typeof e=="object"&&!Array.isArray(e)}function Z(e,t){return typeof e=="boolean"?e:t}function ee(e,t){return typeof e=="number"&&Number.isInteger(e)&&e>=0?e:t}function Ve(e){let t=f.injection;if(e===null||typeof e!="object"||Array.isArray(e))return{...t};let n=e;return{enabled:Z(n.enabled,t.enabled),budget_chars:ee(n.budget_chars,t.budget_chars)}}function Ue(e){let t=f.session_recap;return e===null||typeof e!="object"||Array.isArray(e)?{...t}:{enabled:Z(e.enabled,t.enabled)}}function te(e){if(!w(e))return{...f,injection:{...f.injection},session_recap:{...f.session_recap}};let t=e;return{schema_version:ee(t.schema_version,f.schema_version),injection:Ve(t.injection),session_recap:Ue(t.session_recap)}}function Ye(e){return Je(e,m,Q)}function He(e){let t=Ye(e);if(!Ge(t))return f;try{let n=JSON.parse($e(t,"utf-8"));return w(n)?te(n):f}catch{return f}}function ne(e,t=process.env){return t[q]==="1"?!0:He(e).injection.enabled===!1}import{existsSync as re,mkdirSync as Be,readFileSync as Ke,writeFileSync as ze}from"node:fs";import{dirname as Xe,join as qe}from"node:path";var ie="error-log.json";function oe(e){return qe(e,m,ie)}function Qe(e){let t=Xe(e);re(t)||Be(t,{recursive:!0})}function Ze(e){let t=oe(e);if(!re(t))return[];try{return JSON.parse(Ke(t,"utf-8"))}catch{return[]}}function et(e,t){let n=Ze(e);for(n.push(t);n.length>200;)n.shift();let i=oe(e);Qe(i),ze(i,JSON.stringify(n),"utf-8")}function u(e,t){try{et(e,t)}catch{}}import{existsSync as A,mkdirSync as rn,readFileSync as F,unlinkSync as ot,writeFileSync as on}from"node:fs";import{dirname as an,join as st}from"node:path";var l={enabled:!0,sensitivity:"medium",max_captures_per_session:10,notify:!0,category_filter:{principle:!0,refuted_premise:!1,ephemeral_candidate:!1}},C={total_captured:0,l2_direct:0,l5_captured:0,l5_promoted:0,l5_archived:0,updatedAt:new Date().toISOString()},N="pending-insight-notification.json",T={high:"all opinions, experiences, discoveries, questions, conclusions, analogies, judgments. When in doubt, capture.",medium:"conclusions, deep experiences, significant discoveries, explicit judgments. Skip: simple opinions, incomplete questions, casual remarks.",low:"only verified experience+conclusion pairs, established principles, major discoveries. Skip most."};var tt=["high","medium","low"];function M(e){return e!==null&&typeof e=="object"&&!Array.isArray(e)}function x(e,t){return typeof e=="boolean"?e:t}function nt(e){return tt.includes(e)?e:l.sensitivity}function it(e){return typeof e=="number"&&Number.isInteger(e)&&e>=0?e:l.max_captures_per_session}function rt(e){let t=l.category_filter;if(e===null||typeof e!="object"||Array.isArray(e))return{...t};let n=e;return{principle:x(n.principle,t.principle),refuted_premise:x(n.refuted_premise,t.refuted_premise),ephemeral_candidate:x(n.ephemeral_candidate,t.ephemeral_candidate)}}function se(e){if(!M(e))return{...l};let t=e;return{enabled:x(t.enabled,l.enabled),sensitivity:nt(t.sensitivity),max_captures_per_session:it(t.max_captures_per_session),notify:x(t.notify,l.notify),category_filter:rt(t.category_filter)}}function k(e,...t){return st(e,m,...t)}function j(e){let t=k(e,"insight-config.json");if(!A(t))return l;try{let n=JSON.parse(F(t,"utf-8"));return M(n)?se(n):l}catch{return l}}function at(e){let t=k(e,"auto-insight-stats.json");if(!A(t))return{...C};try{return JSON.parse(F(t,"utf-8"))}catch{return{...C}}}function ae(e){let t=k(e,N);if(!A(t))return null;try{return JSON.parse(F(t,"utf-8"))}catch{return null}}function ce(e){let t=k(e,N);if(A(t))try{ot(t)}catch{}}function ct(e){let t=e.l5_promoted+e.l5_archived;return t===0?null:e.l5_promoted/t}function ue(e){let t=at(e),n=ct(t);if(n===null)return{adjusted:!1,message:null};let i=j(e),o=null;return n<.3&&i.sensitivity!=="low"?o=i.sensitivity==="high"?"medium":"low":n>.8&&i.sensitivity!=="high"&&(o=i.sensitivity==="low"?"medium":"high"),o===null?{adjusted:!1,message:null}:{adjusted:!1,message:`Insight precision is ${(n*100).toFixed(0)}%. Sensitivity adjustment recommended: ${i.sensitivity} \u2192 ${o}`}}function le(e){let t=T[e.sensitivity]??T.medium;return`<auto-insight enabled="${e.enabled}" sensitivity="${e.sensitivity}" max="${e.max_captures_per_session}">
...
</auto-insight>`}var dn={1:"01_Core",2:"02_Derived",3:"03_External",4:"04_Action",5:"05_Context"};var P="2.0.0";function ge(e){if(e===null||typeof e!="object")return!1;let t=e;return typeof t.schema_version=="number"&&t.schema_version>=1&&typeof t.name=="string"&&t.name.length>0&&typeof t.greeting=="string"&&t.greeting.length>0}var p="0.3.9";import{existsSync as De,mkdirSync as ut,readFileSync as lt,writeFileSync as ve}from"node:fs";var de={enabled:!1},fe={version:1,actions:[]},me=()=>({sources:[],updatedAt:new Date().toISOString()}),pe={};var he=[{filename:"insight-config.json",schemaVersion:1,defaultValue:()=>({...l,_schemaVersion:1})},{filename:"auto-insight-stats.json",schemaVersion:1,defaultValue:()=>({...C,updatedAt:new Date().toISOString(),_schemaVersion:1})},{filename:"vault-commit.json",schemaVersion:1,defaultValue:()=>({...de,_schemaVersion:1})},{filename:"lifecycle.json",schemaVersion:1,defaultValue:()=>({...fe,actions:[],_schemaVersion:1})},{filename:"data-sources.json",schemaVersion:1,defaultValue:()=>({...me(),_schemaVersion:1})},{filename:"usage-stats.json",defaultValue:()=>({...pe})}];import{existsSync as ye}from"node:fs";import{join as O}from"node:path";function Se(e){return ye(O(e,H))||ye(O(e,m))}function g(e,...t){return O(e,m,...t)}function _e(e){return O(e,"CLAUDE.md")}async function Ie(){let e=[];for await(let t of process.stdin)e.push(t);return Buffer.concat(e).toString("utf-8")}function Ee(e){process.stdout.write(JSON.stringify(e))}function gt(e,t){let n={...e};for(let[i,o]of Object.entries(t))i in n||(n[i]=o);return n._schemaVersion=t._schemaVersion,n}function Ce(e){let t={created:[],skipped:[],migrated:[]},n=g(e);De(n)||ut(n,{recursive:!0});for(let i of he){let o=g(e,i.filename);if(De(o))if(i.schemaVersion!=null)try{let s=JSON.parse(lt(o,"utf-8"));if((s._schemaVersion??0)<i.schemaVersion){let d=i.defaultValue(),h=gt(s,d);ve(o,JSON.stringify(h),"utf-8"),t.migrated.push(i.filename)}else t.skipped.push(i.filename)}catch(s){u(e,{hook:"config-provisioner",error:String(s),timestamp:new Date().toISOString()}),t.skipped.push(i.filename)}else t.skipped.push(i.filename);else{let s=i.defaultValue();ve(o,JSON.stringify(s),"utf-8"),t.created.push(i.filename)}}return t}var xe=`# Using maencof \u2014 Dialogue Discipline
...
`;var V="maencof-meta-skill";function Oe(e){let t=e.cwd??process.cwd(),n=[];if(!Se(t))return{continue:!0,hookSpecificOutput:{hookEventName:"SessionStart",additionalContext:"[maencof] Vault is not initialized. Run `/maencof:setup` to get started."}};let i=St(t);i&&n.push(`[maencof:${i.name}] ${i.greeting}`),_t(t,i?.name,n);try{let r=Ce(t);r.created.length>0&&n.push(`[maencof] Config files provisioned: ${r.created.join(", ")}`),r.migrated.length>0&&n.push(`[maencof] Config schemas updated: ${r.migrated.join(", ")}`)}catch(r){u(t,{hook:"session-start",error:String(r),timestamp:new Date().toISOString()})}Et(t,n),Dt(t,n);let o=g(t,"wal.json");E(o)&&n.push("[maencof] Incomplete transaction (WAL) detected from a previous session. Run `/maencof:checkup` to diagnose.");let s=g(t,"schedule-log.json");if(E(s))try{let r=JSON.parse(_(s,"utf-8"));r.pending&&r.pending.length>0&&n.push(`[maencof] ${r.pending.length} pending task(s) found. Run \`/maencof:organize\` to process.`)}catch(r){u(t,{hook:"session-start",error:String(r),timestamp:new Date().toISOString()})}let a=g(t,"sessions");if(E(a)){let r=vt(a);r&&n.push(`[maencof] Previous session summary:
${r}`)}let d=g(t,"data-sources.json");try{let r=_(d,"utf-8"),c=JSON.parse(r);(!c.sources||c.sources.length===0)&&n.push("[maencof] No external data sources connected. Run `/maencof:connect` to set up.")}catch(r){u(t,{hook:"session-start",error:String(r),timestamp:new Date().toISOString()}),n.push("[maencof] No external data sources connected. Run `/maencof:connect` to set up.")}try{let r=ue(t);r.message&&n.push(`[maencof] ${r.message}`)}catch(r){u(t,{hook:"session-start",error:String(r),timestamp:new Date().toISOString()})}try{let r=j(t);r.enabled&&n.push(le(r));let c=ae(t);if(c&&c.captures.length>0){let y=c.captures.filter(I=>I.layer===2).length,S=c.captures.filter(I=>I.layer===5).length,R=c.captures.map(I=>`  - L${I.layer}: "${I.title}"`).join(`
`);n.push(`\u{1F4A1} \uC9C0\uB09C \uC138\uC158\uC5D0\uC11C ${c.captures.length}\uAC1C \uC778\uC0AC\uC774\uD2B8\uB97C \uC790\uB3D9 \uCEA1\uCC98\uD588\uC2B5\uB2C8\uB2E4 (L2: ${y}, L5: ${S}):
${R}
/maencof:insight --recent \uB85C \uD655\uC778\uD558\uC138\uC694.`),ce(t)}}catch(r){u(t,{hook:"session-start",error:String(r),timestamp:new Date().toISOString()})}try{let r=e.session_id??"unknown";K(t,{time:z(new Date),category:"session",description:`Session started (session_id: ${r})`})}catch(r){u(t,{hook:"session-start",error:String(r),timestamp:new Date().toISOString()})}let h={continue:!0};try{let r=yt(t),c=n.length>0?n.join(`

`):null,y=ht(r,c);y!==null&&(h.hookSpecificOutput={hookEventName:"SessionStart",additionalContext:y})}catch(r){u(t,{hook:"session-start",error:String(r),timestamp:new Date().toISOString()})}return h}function ht(e,t){return e&&t?`${e}

${t}`:e??t}function yt(e){if(ne(e))return null;let t=xe;return[...t].length>2500?null:`<${V}>
${t}
</${V}>`}function St(e){let t=g(e,"companion-identity.json");if(!E(t))return null;try{let n=JSON.parse(_(t,"utf-8"));return ge(n)?{name:n.name,greeting:n.greeting}:null}catch(n){return u(e,{hook:"session-start",error:String(n),timestamp:new Date().toISOString()}),null}}function _t(e,t,n){let i=!1;try{let o=_e(e),s=Y(o),a=Re(e);if(s===null){let d=b(e,t);L(o,d,{createIfMissing:!0}),Ae(e,p),n.push("[maencof] maencof directives initialized in CLAUDE.md."),i=!0}else if(a===null)Ae(e,p),i=!0;else if(a!==p){let d=b(e,t);L(o,d,{createIfMissing:!1}),It(e,a),n.push(`[maencof] CLAUDE.md directives updated (${a} \u2192 ${p}).`),i=!0}}catch(o){u(e,{hook:"session-start",error:String(o),timestamp:new Date().toISOString()})}return i}function Re(e){let t=g(e,"version.json");if(!E(t))return null;try{return JSON.parse(_(t,"utf-8")).version??null}catch(n){return u(e,{hook:"session-start",error:String(n),timestamp:new Date().toISOString()}),null}}function Ae(e,t){let n=g(e,"version.json"),i={version:t,installedAt:new Date().toISOString(),migrationHistory:[]};ke(n,JSON.stringify(i),"utf-8")}function It(e,t){let n=g(e,"version.json"),i;try{i=JSON.parse(_(n,"utf-8"))}catch(o){u(e,{hook:"session-start",error:String(o),timestamp:new Date().toISOString()}),i={version:t,installedAt:new Date().toISOString(),migrationHistory:[]}}i.migrationHistory.push(`${t} -> ${p}`),i.version=p,i.lastMigratedAt=new Date().toISOString(),ke(n,JSON.stringify(i),"utf-8")}function Et(e,t){try{let n=g(e,"version.json"),i="1.0.0";E(n)&&(i=JSON.parse(_(n,"utf-8")).architecture_version??"1.0.0"),i!==P&&t.push(`[maencof] Architecture update available (${i} \u2192 ${P}).
L3 sub-layers (relational/structural/topical) and L5 sub-layers (buffer/boundary) are now supported.
Run \`/maencof:migrate\` to upgrade your vault structure.`)}catch(n){u(e,{hook:"session-start",error:String(n),timestamp:new Date().toISOString()})}}function Dt(e,t){try{let n=Re(e);n!==null&&n!==p&&t.push(`[maencof] Plugin updated (${n} \u2192 ${p}).
Run \`/maencof:setup\` to complete the migration.`)}catch(n){u(e,{hook:"session-start",error:String(n),timestamp:new Date().toISOString()})}}function vt(e){try{let t=mt(e).filter(s=>s.endsWith(".md")).sort().reverse();if(t.length===0)return null;let n=pt(e,t[0]);return _(n,"utf-8").split(`
`).slice(0,10).join(`
