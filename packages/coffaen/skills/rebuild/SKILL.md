...
Ignores the existing `.coffaen/` index cache and rebuilds the entire knowledge graph from scratch.
This is the force mode of `/coffaen:build`.
...
- When `/coffaen:doctor` recommends a rebuild
