...
신규 skill 추가 시 Tier-1 / 2a / 2b 에 해당하면 `packages/filid/skills/filid-pipeline/SKILL.md` 의 3-layer 패턴을 복제할 것. Terminal stage marker 는 `.omc/research/terminal-markers.json` 에 등록.
