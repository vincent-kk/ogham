import { SEVERITY_ORDER } from '../../../constants/driftMappings.js';
import type {
  DriftItem,
  SyncAction,
  SyncPlan,
...
import { computeOverallRisk } from './utils/computeOverallRisk.js';
import { isReversible } from './utils/isReversible.js';
