import type {
  ToolCallEntry,
  ToolCallSummary,
} from '../../../compress/lossySummarizer/lossySummarizer.js';
import type { CompressionMeta } from '../../../types/documents.js';

import { handleLossy } from './utils/handleLossy.js';
import { handleReversible } from './utils/handleReversible.js';
import { inferMode } from './utils/inferMode.js';
