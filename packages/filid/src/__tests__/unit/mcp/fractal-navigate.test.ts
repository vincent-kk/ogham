...
import { handleFractalNavigate } from '../../../mcp/tools/fractal-navigate/fractal-navigate.js';
...
describe('fractal-navigate tool', () => {
  ...
  describe('action: tree', () => {
    ...
    it('should expose tree.nodes as a flat array', () => {
      const result = handleFractalNavigate({
        action: 'tree',
        path: '/app',
        entries: sampleEntries,
    ...
    it('should NOT serialize tree.nodes as a Map', () => {
      const result = handleFractalNavigate({
        action: 'tree',
        path: '/app',
        entries: sampleEntries,
