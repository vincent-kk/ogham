...
- When `scan` reports `CLAUDE.md` files that should be `INTENT.md`

### Relationship with Other Skills

- **scan**: May report legacy `CLAUDE.md` files as violations — run this skill to fix them.
- **init**: Generates `INTENT.md`/`DETAIL.md` for new projects. This skill migrates old projects to the same convention.
- **update**: After migration, use `update` to verify INTENT.md/DETAIL.md content is current.
