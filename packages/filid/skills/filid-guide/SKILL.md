...
Retrieve the full directory tree and node classifications using the `mcp_t_fractal_scan`
MCP tool. If `mcp_t_fractal_scan` returns an empty tree (no FCA-AI project detected or
...
Fetch all active rules using `mcp_t_rule_query` (`action: "list"`) to build the rule
...
| Tool           | Action | Purpose                                                      |
| -------------- | ------ | ------------------------------------------------------------ |
| `mcp_t_fractal_scan` | —      | Retrieve complete project hierarchy and node classifications |
| `mcp_t_rule_query`   | `list` | Fetch all active rules                                       |
