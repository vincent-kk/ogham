...
Resolve phase file path via `${CLAUDE_PLUGIN_ROOT}/skills/filid-review/phases/phase-c-verification.md`.
Fallback: `Glob(**/skills/filid-review/phases/phase-c-verification.md)`.
...
```
/filid:filid-review                           # Full review (Phase A + B + C + D)
/filid:filid-review --scope=pr                # Review + post PR comment
/filid:filid-review --force                   # Force restart from Phase A
/filid:filid-review --no-structure-check      # Skip Phase A structure pre-check (faster)
