...
| `filid-promote` | no | `Skill("filid:filid-promote")` | test.ts → spec.ts promotion (3+12 compliance) |
| `filid-restructure` | no | `Skill("filid:filid-restructure")` | Module split/reorganization (LCOM4 >= 2) |
