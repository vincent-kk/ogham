# filid-pull-request — Reference Documentation
...
### Resolution
1. Try manual sync with `/filid:filid-update --force`
2. Fix the issue, then re-run `/filid:filid-pull-request`
```
...
- `feat(filid): add "filid:filid-pull-request" skill for automated PR generation`
