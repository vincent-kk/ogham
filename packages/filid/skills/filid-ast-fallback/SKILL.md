...
# filid-ast-fallback — AST Pattern Matching Fallback
...
```
/filid:filid-ast-fallback <pattern> [--language <lang>] [--path <dir>] [--replace <replacement>]
```
...
/filid:filid-ast-fallback "console.log($MSG)"

# Search in specific directory for Python
/filid:filid-ast-fallback "def $NAME($$$ARGS)" --language python --path src/

# Replace var with const
/filid:filid-ast-fallback "var $NAME = $VALUE" --replace "const $NAME = $VALUE"
