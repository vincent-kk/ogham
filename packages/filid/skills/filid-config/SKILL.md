...
- Setting the output language for documents: `/filid:filid-config set language ko`
- Checking current configuration: `/filid:filid-config` or `/filid:filid-config show`
- Disabling a rule: `/filid:filid-config set rules.naming-convention.enabled false`
- Changing rule severity: `/filid:filid-config set rules.max-depth.severity warning`
- Resetting to defaults: `/filid:filid-config reset`
...
```
/filid:filid-config set language ko
/filid:filid-config set rules.naming-convention.enabled false
/filid:filid-config set rules.max-depth.severity warning
```
...
```
/filid:filid-config reset          # reset rules, keep language
/filid:filid-config reset --full   # reset everything
```
...
```
/filid:filid-config [show]
/filid:filid-config set <key> <value>
/filid:filid-config reset [--full]
```
