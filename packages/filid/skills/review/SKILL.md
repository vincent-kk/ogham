...
Resolve phase file path via `${CLAUDE_PLUGIN_ROOT}/skills/review/phases/phase-a-structure.md`.
Fallback: `Glob(**/skills/review/phases/phase-a-structure.md)`.
...
Resolve phase file path via `${CLAUDE_PLUGIN_ROOT}/skills/review/phases/phase-b-analysis.md`.
Fallback: `Glob(**/skills/review/phases/phase-b-analysis.md)`.
...
Resolve phase file path via `${CLAUDE_PLUGIN_ROOT}/skills/review/phases/phase-c-verification.md`.
Fallback: `Glob(**/skills/review/phases/phase-c-verification.md)`.
...
| `review_manage`  | `format-revalidate-comment` | Format re-validation results (used by revalidate) |
...
```
/filid:review [--scope=branch|pr|commit] [--base=<ref>] [--force] [--verbose] [--no-structure-check]
```
...
```
/filid:review                           # Full review (Phase A + B + C + D)
/filid:review --scope=pr                # Review + post PR comment
/filid:review --force                   # Force restart from Phase A
/filid:review --no-structure-check      # Skip Phase A structure pre-check (faster)
