      ...
      content: [
        {
          ...
          content: [
            {
              type: "media",
              attrs: { id: "abc-123", type: "image", fileName: "photo.png" },
            },
          ],
        },
      ],
      ...
      content: [
        {
          ...
          content: [
            {
              type: "media",
              attrs: { id: "def-456", type: "file", fileName: "document.pdf" },
            },
          ],
        },
      ],
      ...
      content: [
        {
          ...
          content: [
            {
              type: "media",
              attrs: { id: "a1", type: "image", fileName: "img1.png" },
            },
            {
              type: "media",
              attrs: { id: "a2", type: "file", fileName: "doc.pdf" },
            },
          ],
        },
      ],
  ...
  it("preserves mention with @ prefix", () => {
    const adf = {
      ...
      content: [
        {
          type: "paragraph",
          content: [{ type: "mention", attrs: { text: "@John Doe" } }],
        },
      ],
    };
  ...
  it("uses displayName fallback for mention", () => {
    const adf = {
      ...
      content: [
        {
          type: "paragraph",
          content: [{ type: "mention", attrs: { displayName: "Bob Smith" } }],
        },
      ],
    };
  ...
  it("uses id fallback for mention without text", () => {
    const adf = {
      ...
      content: [
        {
          type: "paragraph",
          content: [{ type: "mention", attrs: { id: "account123" } }],
        },
      ],
    };
