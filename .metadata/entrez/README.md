...
| [mcp-tools.md](./mcp-tools.md) | MCP 도구 5종 스펙 (`paper_search`·`mesh_lookup`·`fetch_fulltext`·`setup`·`auth-check`) + TypeScript 인터페이스 |
...
| [setup.md](./setup.md) | `setup` web UI 설정, credentials/config 분리, `auth-check` reachability |
