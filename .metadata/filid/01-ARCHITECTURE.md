...
│  ┌──────────────────────────────────────────────────────────────┐ │
│  │                     Skills (19 명령)                          │ │
│  │  /filid:setup │ /filid:scan │ /filid:sync │ /filid:cross-review │ /filid:promote│ │
│  │  /filid:guide │ /filid:restructure │ /filid:resolve │ /filid:revalidate│ │
│  │  /filid:migrate │ /filid:pipeline │ /filid:pull-request │ /filid:update│ │
│  │  /filid:context-query │ /filid:structure-review │ /filid:ast-fallback│ │
│  │  /filid:config-wizard │ /filid:enrich-docs │ /filid:harvest│ │
│  └──────────────────────────────────────────────────────────────┘ │
└──────────────────────────────────────────────────────────────────┘
```
...
│   ├── update/SKILL.md
│   ├── config-wizard/SKILL.md
│   ├── enrich-docs/SKILL.md
│   ├── harvest/SKILL.md
│   └── ast-fallback/SKILL.md
├── src/                         # TypeScript 소스
...
코드 리뷰 거버넌스는 별도 Layer가 아닌 **Layer 4 (Skills) 내부 프레임워크**로 설계되었다. 3개 스킬(`cross-review`, `resolve`, `revalidate`)이 하나의 거버넌스 라이프사이클을 형성한다.

```
/filid:cross-review ──→ /filid:resolve ──→ /filid:revalidate
