...
│  ┌──────────────────────────────────────────────────────────────┐ │
│  │                     Skills (16 명령)                          │ │
│  │  /filid:filid-setup │ /filid:filid-scan │ /filid:filid-sync │ /filid:filid-review │ /filid:filid-promote│ │
│  │  /filid:filid-guide │ /filid:filid-restructure │ /filid:filid-resolve │ /filid:filid-revalidate│ │
│  │  /filid:filid-migrate │ /filid:filid-pipeline │ /filid:filid-pull-request │ /filid:filid-update│ │
│  │  /filid:filid-context-query │ /filid:filid-structure-review │ /filid:filid-ast-fallback│ │
│  └──────────────────────────────────────────────────────────────┘ │
└──────────────────────────────────────────────────────────────────┘
```
...
│   ├── review/              # 거버넌스: phases/, personas/, state-machine.md
│   ├── resolve/             # 거버넌스: 수정 해결
