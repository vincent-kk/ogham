...
| 03  | [LIFECYCLE.md](./03-LIFECYCLE.md)             | 라이프사이클 & 워크플로우 — 16개 스킬 기반, 에이전트 협업, Hook 타임라인, 거버넌스 파이프라인 |
...
| 스킬             | 16개 (/filid:filid-setup, /filid:filid-scan, /filid:filid-sync, /filid:filid-structure-review, /filid:filid-promote, /filid:filid-context-query, /filid:filid-review, /filid:filid-resolve, /filid:filid-revalidate, /filid:filid-guide, /filid:filid-restructure, /filid:filid-migrate, /filid:filid-pipeline, /filid:filid-pull-request, /filid:filid-update, /filid:filid-ast-fallback)   |
