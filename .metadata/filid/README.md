...
| 스킬             | 16개 (/filid:init, /filid:scan, /filid:sync, /filid:structure-review, /filid:promote, /filid:context-query, /filid:review, /filid:resolve, /filid:revalidate, /filid:guide, /filid:restructure, /filid:migrate, /filid:pipeline, /filid:pull-request, /filid:update, /filid:ast-fallback)   |
