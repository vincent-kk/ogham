...
| 스킬             | 16개 (/init, /scan, /sync, /structure-review, /promote, /context-query, /review, /resolve, /revalidate, /guide, /restructure, /migrate, /pipeline, /pull-request, /update, /ast-fallback)   |
