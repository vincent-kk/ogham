 ...
 */
import { buildGraph, calculateWeights, hydrateRuntimeMaps } from './graphBuild.mjs';
...
const FIXTURE_DOCS = [
  { path: 'L1/identity.md', title: 'Identity Core', layer: 1, tags: ['identity', 'core'] },
  { path: 'L1/values.md', title: 'Values and Principles', layer: 1, tags: ['identity', 'values'] },
  { path: 'L2/index.md', title: 'Derived Knowledge Index', layer: 2, tags: ['index'] },
  {
  ...
  { path: 'L3/index.md', title: 'External Knowledge Index', layer: 3, tags: ['index'] },
  {
