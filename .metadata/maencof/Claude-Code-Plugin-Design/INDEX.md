...
maencof은 5-Layer 지식 모델 + 지식 그래프 검색 엔진 기반의 개인 지식공간 관리 Claude Code 플러그인이다.
...
| 4    | 27  | Personal Context 층         | [27](./27-personal-context.md)                  |
| 3    | 28  | 세션 완결 finalizer   | [28](./28-session-finalizer.md)           |
...
| Personal Context 변경                           | 16, 17, 18, 27             |
