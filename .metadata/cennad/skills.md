...
| cennad alias | codex 모델                                                  |
| ------------ | ----------------------------------------------------------- |
| `high`       | codex-cli 기본값 (env `CENNAD_CODEX_HIGH` 설정 시 override) |
| `mid`        | codex-cli 기본값 (env `CENNAD_CODEX_MID` 설정 시 override)  |
| `low`        | codex-cli 기본값 (env `CENNAD_CODEX_LOW` 설정 시 override)  |
