...
- [ ] **T1 배선 검증 8항목** — 격리 프로젝트에서 1회. S3 조건부 · 밸브 왕복/비추적 · 발동 폭 · SubagentStart 주입 · 실패 연쇄 임계/dedup/리셋 · advisory 무비용. **머지 전 전부 통과 필요**(실패는 관측 대상이 아니라 배선 결함). 인계 프롬프트: [phase0/t1-handoff.md](./phase0/t1-handoff.md)
- [ ] **T2 사후 관측 개시** — 항목별 최소 3사례 누적 시 판정. D13 적중/오발화 · D12 서브에이전트 참조 · D10 발화 폭 · 컴팩션 생존 · S3 실로드
