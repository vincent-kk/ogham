...
- **예상 밖 사실 1건이 정본 전제와 충돌**: baseline이 advisory가 아니라 standard(아래 §"예상 밖 사실" 1번). T2의 "advisory 기준선" 전제(정본 §4)에 직접 영향 — **T2 착수 전 결정 필요.** _(→ 2026-07-24: `DEFAULT_INTERVENTION`이 standard로 확정되어, 이 충돌은 스크래치 아티팩트가 아니라 실제 배포 기본값이 됐다. ext-observation §1.1·§4 재역전 참조.)_
