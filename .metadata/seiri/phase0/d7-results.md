...
> **재측정 (2026-07-25)**: 5세대 모델(sonnet-5·opus-5) 프록시 재측정에서 발화 1/22로 붕괴 — 원인은 모델 세대(런타임·주입·rename은 배제), 행동 품질은 불변. 본 문서의 발화율과 "SessionStart 안내 불필요" 권고는 **opus-4-8 한정**. 상세: [d7-gen5-results.md](./d7-gen5-results.md).
