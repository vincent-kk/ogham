...
| `getJiraIssue` | `get_issue` | split, devplan, read-issue |
...
|------|---------|-----------|
| `getConfluencePage` | validate, fetch-media | When source is Confluence URL |
| `searchConfluenceUsingCql` | validate (analyst) | Related spec search |
| `fetchAtlassian` | fetch-media | Attachment download |
...
| fetch-media | getConfluencePage, fetchAtlassian | (none) |
| digest | (via read-issue) | addCommentToJiraIssue |
| read-issue | getJiraIssue | (none) |
