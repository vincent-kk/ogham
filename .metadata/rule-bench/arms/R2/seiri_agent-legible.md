...
Purpose from its name and head, dependencies from its imports, effect from its exports. When one file needs several others open at once, split it or localize what it depends on.
