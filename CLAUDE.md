...
- `bridge/` and `public/` contain generated runtime artifacts. Rebuild them without hand edits and commit them in a separate build commit after the source commits.
