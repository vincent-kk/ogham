...
- **Package**: `@ogham/atlassian` (v0.1.0) — Jira/Confluence 통합 plugin (6 MCP tools, 2 agents, 4 skills)

```
packages/filid/      # FCA-AI 프랙탈 구조 규칙 엔진 (16 MCP tools, 7 agents, 17 skills)
packages/maencof/    # 마크다운 Knowledge Graph 기반 지식 관리 (17 MCP tools, 4 agents, 29 skills)
packages/atlassian/  # Jira/Confluence REST API 통합 (6 MCP tools, 2 agents, 4 skills)
```
