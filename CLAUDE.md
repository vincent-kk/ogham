...
- **Package**: `@ogham/atlassian` (v0.1.0) — Jira/Confluence 통합 plugin (3 MCP tools, 2 agents, 4 skills)
...
packages/atlassian/  # Jira/Confluence REST API 통합 (3 MCP tools, 2 agents, 4 skills)
```
