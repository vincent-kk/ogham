...
- **Package**: `@ogham/cogair` (v0.0.1) — Codex CLI / Gemini CLI 자율 위임 plugin (3 MCP tools, 3 skills, 2 hooks)
...
packages/cogair/     # Gemini/Codex CLI 자율 위임 (3 MCP tools, 3 skills, 2 hooks)
```
